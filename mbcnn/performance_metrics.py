...
from mbcnn import utils
from mbcnn.models import unmixing_pixel_based_dcae, unmixing_cube_based_dcae, \
...
UNMIXING_LOSSES = {
    ...
    multiple_feature_learning_model_base.__name__: 'mse',
    multiple_feature_learning_model_rezidual.__name__: 'mse',
    multiple_feature_learning_model_feature_extraction.__name__: 'mse',
    multiple_feature_learning_model_feature_extraction_rezidual.__name__: 'mse',
    multiple_output_feature_learning_model.__name__: ['mse', 'mse', 'mse'],

    unmixing_linear.__name__: 'mse',
    unmixing_svr.__name__: None,
    unmixing_deep_cnn.__name__: 'mse'
}
